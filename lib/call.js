...
var deploylessMulticallAbi = __importStar(require("./abi/deploylessMulticall.json"));
var deploylessMulticall2Abi = __importStar(require("./abi/deploylessMulticall2.json"));
var deploylessMulticall3Abi = __importStar(require("./abi/deploylessMulticall3.json"));
var multicallAbi = __importStar(require("./abi/multicall.json"));
var multicall2Abi = __importStar(require("./abi/multicall2.json"));
var multicall3Abi = __importStar(require("./abi/multicall3.json"));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    contract = multicall
                        ? new contracts_1.Contract(multicall.address, multicallAbi, provider)
                        : null;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    contract = multicall2
                        ? new contracts_1.Contract(multicall2.address, multicall2Abi, provider)
                        : null;
                    callRequests = calls.map(function (call) {
                        var callData = abi_1.default.encode(call.name, call.inputs, call.params);
                        return {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    contract = multicall3
                        ? new contracts_1.Contract(multicall3.address, multicall3Abi, provider)
                        : null;
                    callRequests = calls.map(function (call) {
                        var callData = abi_1.default.encode(call.name, call.inputs, call.params);
                        return {
...
function callDeployless(provider, callRequests, block) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    inputAbi = deploylessMulticallAbi;
...
function callDeployless2(provider, callRequests, block) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    inputAbi = deploylessMulticall2Abi;
                    constructor = inputAbi.find(function (f) { return f.type === 'constructor'; });
                    inputs = (constructor === null || constructor === void 0 ? void 0 : constructor.inputs) || [];
...
function callDeployless3(provider, callRequests, block) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    inputAbi = deploylessMulticall3Abi;
                    constructor = inputAbi.find(function (f) { return f.type === 'constructor'; });
                    inputs = (constructor === null || constructor === void 0 ? void 0 : constructor.inputs) || [];
                    args = abi_1.default.encodeConstructor(inputs, [callRequests]);
